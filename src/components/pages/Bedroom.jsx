...
function Bedroom() {
  ...
  const bedroom_pics = [
    {
      id: 1, cover: "../images/bedroom/bedroom.jpg",
      name: "Wooden wall light Design"
    }
    , {
      id: 2, cover: "../images/bedroom/bedroom1.jpg",
      name: "Wooden wall light Design"
    }
    , {
      id: 3, cover: "../images/bedroom/bedroom2.jpg",
      name: "Wooden wall light Design"
    }
    , {
      id: 4, cover: "../images/bedroom/kidsbed.webp",
      name: "Wooden wall light Design"
    }
    , {
      id: 5
      , cover: "../images/bedroom/plac-1.jpg",
      name: "Wooden wall light Design"
    }];
  return (
    <>
